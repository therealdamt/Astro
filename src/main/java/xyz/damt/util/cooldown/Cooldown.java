...
public final class Cooldown {
    ...
    public boolean isOnCooldown(Player p) {
        return this.cooldownMap.containsKey(p.getUniqueId()) && (Long) this.cooldownMap.get(p.getUniqueId()) >= System.currentTimeMillis();
    }

    public long getRemaining(Player p) {
        return (Long) this.cooldownMap.get(p.getUniqueId()) - System.currentTimeMillis();
    }
